...
public class Recipe {
    ...
    public Recipe(String uid, String name, String description, Timestamp date, String picture,
    ...
    public Recipe(String id, String name, String description, Timestamp date, String picture, HashMap<String, Boolean> extra, ArrayList<Object> steps, Boolean interactive, ArrayList<String> ingredients, HashMap<String, Long> ratings, String user, String tipo, int duration) {
    ...
    public Recipe(String id, String name, String description, Timestamp date, String picture, HashMap<String, Boolean> extra, ArrayList<Object> steps,
